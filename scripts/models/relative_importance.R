...
results_models$weight_fom <- compute_weights(results_models$fom, maximize = TRUE)
results_models$weight_auc <- compute_weights(results_models$spatial_auc, maximize = TRUE)
results_models$weight_aic <- compute_weights(results_models$aic, maximize = FALSE)

results_models$variables

importance_auc <- compute_variable_importance(results_models$variables, results_models$weight_auc)
