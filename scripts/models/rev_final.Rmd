...
setwd("C:/Users/CRISTIAN/Universidad de Alcala/PUBLICACIONES UAH - Spatial logistic model forest plantation chile/datos/modelo_8701/datos_modelo/test2")
...
lingue_puntos_gpkg <- st_read(dsn = "li_datos8701_completo.gpkg", layer = "li_pts_18s")
...
```{r}
group_by(lingue_puntos_gpkg, gali_8701_) %>% dplyr::summarise(n())
```
...
dir <- ("C:/Users/CRISTIAN/Universidad de Alcala/PUBLICACIONES UAH - Spatial logistic model forest plantation chile/datos/modelo_8701/datos_modelo/test2")
...
test_lingue_8701 <- glmulti(gali_8701_ ~ aptitud_agricola_lingue + aptitud_forVII_lingue + bn_lingue_87 + mat_lingue_87 + cul_prad_lingue_87 + dis_comunidades_lingue + dis_urbano_lingue + dis_caminos_lingue + dis_hid_lingue + contag_600 + shdi_600 + econ_mn_600 + enn_mn_600 + pland_1  + pen_lingue15 + dis_plant87_lingue + predios_lingue1, level = 1, data = spdf_train, family = binomial, method = "h", confsetsize = 300, crit = aic, plotty = TRUE, report = TRUE)
...
bw <- bw.ggwr(gali_8701_ ~ aptitud_agricola_lingue + aptitud_forVII_lingue + bn_lingue_87 + mat_lingue_87 + cul_prad_lingue_87 + dis_comunidades_lingue + dis_urbano_lingue + dis_caminos_lingue + dis_hid_lingue + contag_600 + shdi_600 + econ_mn_600 + pen_lingue15 + dis_plant87_lingue + predios_lingue1, data = spdf_train, family = "binomial", approach = "aic", kernel = "bisquare", adaptive = T, dMat = DM_train) 

```

```{r, warning = FALSE, message = FALSE, echo=FALSE, include=FALSE}
res.binomial <- ggwr.basic(gali_8701_ ~ aptitud_agricola_lingue + aptitud_forVII_lingue + bn_lingue_87 + mat_lingue_87 + cul_prad_lingue_87 + dis_comunidades_lingue + dis_urbano_lingue + dis_caminos_lingue + dis_hid_lingue + contag_600 + shdi_600 + econ_mn_600 + pen_lingue15 + dis_plant87_lingue + predios_lingue1, data = spdf_train, bw = bw, kernel = "bisquare", family = "binomial", adaptive = T, dMat = DM_train)
...
coef <- dplyr::select(res.binomial$SDF@data, c("aptitud_agricola_lingue", "aptitud_forVII_lingue", "bn_lingue_87", "mat_lingue_87", "cul_prad_lingue_87", "dis_comunidades_lingue", "dis_urbano_lingue", "dis_caminos_lingue", "dis_hid_lingue", "contag_600", "shdi_600", "econ_mn_600", "pen_lingue15", "dis_plant87_lingue",  "predios_lingue1"))
...
# pen_cat
modelo_final <- glm(gali_8701_ ~ aptitud_agricola_lingue + aptitud_forVII_lingue + bn_lingue_87 + mat_lingue_87 + cul_prad_lingue_87 + dis_comunidades_lingue + dis_urbano_lingue + dis_caminos_lingue + dis_hid_lingue + contag_600 + shdi_600 + econ_mn_600 + pen_lingue15 + dis_plant87_lingue + predios_lingue1, spdf_train, family = binomial(), na.action = "na.omit")
