...
dir <- ("C:/Users/CRISTIAN/Universidad de Alcala/PUBLICACIONES UAH - Spatial logistic model forest plantation chile/datos/modelo_8715/datos_modelo")
...
summary(test_lingue_8701@objects[[43]])
...
anova(test_lingue_8701@objects[[43]], test ="LRT")
...
```{r}
avg_lingue8701_1 <- coef.glmulti(test_lingue_8701, select= 43, varweighting ="Buckland", icmethod ="Lukacs")
```
...
```{r}
avg_lingue8701_43<- coef.glmulti(test_lingue_8701, select= as.integer(43), varweighting ="Buckland", icmethod ="Lukacs")
```
